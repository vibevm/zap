...
specmark::scope!("spec://org.vibevm.world/zap/flows/zap/ZAP-AGENT-PROTOCOL#AGENT-GOAL-APPLICATION");
...
fn descriptor(
    ...
    CellDescriptor::new(CellDescriptorInput {
        ...
        requirements: vec![RequirementRef::parse(
            "spec://org.vibevm.world/zap/flows/zap/ZAP-AGENT-PROTOCOL#AGENT-GOAL-APPLICATION",
        )?],
