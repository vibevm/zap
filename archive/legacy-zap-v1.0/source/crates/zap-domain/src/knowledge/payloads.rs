...
schema_tag!(
    ...
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#source-capture"
);
schema_tag!(
    NativeFactsRecordedSchema,
    "zap-domain/native-facts-recorded/1",
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#fact-lifecycle"
);
schema_tag!(
...
schema_tag!(
    ...
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#source-observations"
);
schema_tag!(
...
schema_tag!(
    ...
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#knowledge-relations"
);
schema_tag!(
    ClosureAssessedSchema,
    "zap-domain/closure-assessed/1",
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#knowledge-applicability"
);
schema_tag!(
...
schema_tag!(
    ...
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#unknown-regions"
);
schema_tag!(
...
schema_tag!(
    ...
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#semantic-assessment"
);
schema_tag!(
    FactProposedSchema,
...
schema_tag!(
    ...
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#adaptive-review"
);
schema_tag!(
    ReviewAppliedSchema,
