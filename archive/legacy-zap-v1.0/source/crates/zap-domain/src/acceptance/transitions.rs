...
const CLOSURE_REQ: &str = "spec://org.vibevm.world/zap/flows/zap/ZAP-METHODOLOGY#CAMPAIGN-CLOSURE";
...
pub fn record_promotion(
        ...
        || !evidence.matches(&payload.evidence_ids, payload.basis)
    {
        return refuse(
            ErrorCode::NeedsEvidence,
            "spec://org.vibevm.world/zap/flows/zap/ZAP-METHODOLOGY#PROMOTE-FACTS",
