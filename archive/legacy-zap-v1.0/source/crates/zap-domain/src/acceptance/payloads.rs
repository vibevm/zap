...
schema_tag!(
    ...
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#evidence-adjudication"
);
schema_tag!(
    StageAcceptedSchema,
    "zap-domain/stage-accepted/1",
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#stage-acceptance"
);
schema_tag!(
    IntegrationAcceptedSchema,
    "zap-domain/integration-accepted/1",
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#integration-acceptance"
);
schema_tag!(
    WorkAcceptedSchema,
    "zap-domain/work-accepted/1",
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#work-acceptance"
);
schema_tag!(
    PromotionRecordedSchema,
    "zap-domain/fact-promotion-recorded/1",
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#promotion-closure"
);
schema_tag!(
