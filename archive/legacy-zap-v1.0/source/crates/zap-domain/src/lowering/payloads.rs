...
schema_tag!(
    ...
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#strategic-plan"
);
schema_tag!(
    LoweringAppliedSchema,
    "zap-planning/lowering-applied/2",
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#lowered-graph"
);
schema_tag!(
    PacketRenderedSchema,
    "zap-planning/packet-rendered/2",
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#packet-assembly"
);
