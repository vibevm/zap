...
schema_tag!(
    ...
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#bundle-publication"
);
schema_tag!(
...
schema_tag!(
    ...
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#returned-bundle"
);
schema_tag!(
    ReturnReassessmentProposedSchema,
    "zap-planning/return-reassessment-proposed/1",
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#return-reassessment"
);
