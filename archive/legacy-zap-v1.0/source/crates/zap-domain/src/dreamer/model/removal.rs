specmark::scope!(
    "spec://org.vibevm.world/zap/flows/zap/ZAP-LOWERING-AND-DREAMER#DREAMER-REMOVAL-CONSERVATION"
);
...
#[spec(
    implements = "spec://org.vibevm.world/zap/flows/zap/ZAP-LOWERING-AND-DREAMER#DREAMER-REMOVAL-CONSERVATION"
)]
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#dream-removal")]
