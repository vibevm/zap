...
impl ZapError {
    ...
    pub fn from_static(
        ...
        let message = if !message.is_empty() && message.len() <= 4096 {
            ...
            BoundedText::trusted(
                "violates REQ spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-STORAGE#RUST-STORAGE-TRUTHFUL-CAPABILITIES: diagnostic text exceeded its bound; fix surface: configuration",
            )
        };
