...
specmark::scope!("spec://org.vibevm.world/zap/flows/zap/ZAP-AGENT-PROTOCOL#AGENT-DEFAULT-PROFILES");

macro_rules! profile_name {
    ($name:ident, $label:literal) => {
        #[derive(Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd, Serialize, Deserialize)]
        #[serde(transparent)]
        #[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-CORE-GUIDE#worker-profiles")]
            ...
            pub fn parse(value: &str) -> Result<Self, ZapError> {
                BoundedText::parse(value).map(Self).map_err(|_| {
                    ZapError::from_static(
                        ...
                        "spec://org.vibevm.world/zap/flows/zap/ZAP-AGENT-PROTOCOL#AGENT-DEFAULT-PROFILES",
...
#[spec(
    implements = "spec://org.vibevm.world/zap/flows/zap/ZAP-AGENT-PROTOCOL#AGENT-DEFAULT-PROFILES"
)]
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-CORE-GUIDE#worker-profiles")]
