...
#[spec(implements = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUNTIME#BACKEND-CONSISTENCY")]
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-MACHINE-GUIDE#read-surface")]
...
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-MACHINE-GUIDE#snapshot-events")]
...
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-MACHINE-GUIDE#index-traversal")]
...
#[serde(deny_unknown_fields)]
#[spec(
    implements = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-STORAGE#RUST-STORAGE-ALGORITHMIC-NAVIGATION"
)]
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-MACHINE-GUIDE#index-traversal")]
...
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-MACHINE-GUIDE#query-pages")]
