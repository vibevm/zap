...
#[serde(transparent)]
#[spec(implements = "spec://org.vibevm.world/zap/flows/zap/ZAP-LOWERING-AND-DREAMER#DREAMER-GRILL")]
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#dream-grill")]
...
#[spec(
    implements = "spec://org.vibevm.world/zap/flows/zap/ZAP-LOWERING-AND-DREAMER#DREAMER-INTENT-MODES"
)]
...
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#dream-assumptions")]
...
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#dream-delta")]
pub struct DreamAdd {
