...
Version 1.1 extends that baseline with the separately specified
[strategic-map contract](ZAP-STRATEGIC-MAP.xml) and
[map usage guide](ZAP-STRATEGIC-MAP-GUIDE.md). The test inventory and historical
measurements below describe the accepted 1.0 baseline; they are not a claim
that those counts include the subsequent map implementation.
