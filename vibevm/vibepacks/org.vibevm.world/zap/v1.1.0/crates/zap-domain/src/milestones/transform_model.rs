...
specmark::scope!("spec://org.vibevm.world/zap/flows/zap/ZAP-MILESTONES#MILESTONE-TRANSFORM");

schema_tag!(
    MilestoneTransformAppliedSchema,
    "zap-domain/milestone-transform-applied/1",
    "spec://org.vibevm.world/zap/flows/zap/ZAP-MILESTONES-GUIDE#transforms"
);

#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(tag = "kind", rename_all = "snake_case")]
#[spec(implements = "spec://org.vibevm.world/zap/flows/zap/ZAP-MILESTONES#MILESTONE-TRANSFORM")]
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-MILESTONES-GUIDE#transforms")]
