...
specmark::scope!("spec://org.vibevm.world/zap/flows/zap/ZAP-MILESTONES#MILESTONE-ADMISSION");

const DISCOVERY: &str = "spec://org.vibevm.world/zap/flows/zap/ZAP-MILESTONES#MILESTONE-DISCOVERY";
const ADMISSION: &str = "spec://org.vibevm.world/zap/flows/zap/ZAP-MILESTONES#MILESTONE-ADMISSION";
const PROLIFERATION: &str =
    "spec://org.vibevm.world/zap/flows/zap/ZAP-MILESTONES#MILESTONE-PROLIFERATION";
...
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-MILESTONE-PLANNING-GUIDE#commands")]
