...
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-MILESTONES-GUIDE#relationships")]
...
#[serde(rename_all = "snake_case")]
#[spec(implements = "spec://org.vibevm.world/zap/flows/zap/ZAP-MILESTONES#MILESTONE-HISTORY")]
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-MILESTONES-GUIDE#current-validity")]
