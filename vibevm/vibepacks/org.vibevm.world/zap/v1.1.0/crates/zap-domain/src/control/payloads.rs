...
schema_tag!(
    ...
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#task-contract"
);
schema_tag!(
    RevalidationReadiedSchema,
    "zap-domain/work-revalidation-readied/1",
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#revalidation-ready"
);
schema_tag!(
    WorkRenamedSchema,
    "zap-domain/work-renamed/1",
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#work-transitions"
);
schema_tag!(
...
schema_tag!(
    ...
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#obligation-coverage"
);
schema_tag!(
    DeferralCreatedSchema,
    "zap-domain/deferral-created/1",
    "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#deferral-lifecycle"
);
schema_tag!(
...
#[spec(implements = "spec://org.vibevm.world/zap/flows/zap/ZAP-ADAPTIVE-CYCLE#PLAN-RECONCILIATION")]
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#task-contract")]
...
#[spec(implements = "spec://org.vibevm.world/zap/flows/zap/ZAP-ADAPTIVE-CYCLE#PLAN-RECONCILIATION")]
#[spec(
    documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#revalidation-ready"
)]
...
#[serde(deny_unknown_fields)]
#[spec(
    implements = "spec://org.vibevm.world/zap/flows/zap/ZAP-ADAPTIVE-CYCLE#LIVE-WORK-RECONCILIATION"
)]
#[spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#work-transitions")]
...
#[spec(
    documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#obligation-coverage"
)]
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
#[spec(implements = "spec://org.vibevm.world/zap/flows/zap/ZAP-METHODOLOGY#FORMAL-DEFERRALS")]
#[spec(
    documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#deferral-lifecycle"
)]
