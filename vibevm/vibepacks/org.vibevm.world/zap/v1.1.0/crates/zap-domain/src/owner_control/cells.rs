...
const CONTROL_REQ: &str = "spec://org.vibevm.world/zap/flows/zap/ZAP-METHODOLOGY#STICKY-PAUSE";
const ECONOMICS_REQ: &str =
    "spec://org.vibevm.world/zap/flows/zap/ZAP-CHANGE-ECONOMICS#DECISION-CHOICES";
...
macro_rules! owner_cell {
    ($name:ident, $payload:ty, $class:expr, [$($family:expr),* $(,)?], $requirement:expr, $body:expr) => {
        #[specmark::spec(documents = "spec://org.vibevm.world/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#internal-boundaries")]
        pub struct $name;
...
impl TransitionCell for StopRuleTriggeredCell {
    ...
    fn descriptor(&self) -> Result<zap_core::CellDescriptor, ZapError> {
        cell_descriptor(
            ...
            &[PauseRecord::FAMILY],
            "spec://org.vibevm.world/zap/flows/zap/ZAP-METHODOLOGY#WHOLE-CAMPAIGN-STOP",
            false,
        )
    }
...
owner_cell!(
    ...
    "spec://org.vibevm.world/zap/flows/zap/ZAP-METHODOLOGY#RESUME-AND-RULES",
    |state: &dyn StateReader,
...
owner_cell!(
    ...
    "spec://org.vibevm.world/zap/flows/zap/ZAP-METHODOLOGY#APPROACH-IDENTITY",
    |state: &dyn StateReader,
