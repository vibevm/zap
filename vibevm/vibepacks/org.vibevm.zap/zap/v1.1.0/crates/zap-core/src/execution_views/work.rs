...
macro_rules! checked_counter {
    ($name:ident, $allow_zero:expr) => {
        ...
        #[serde(transparent)]
        #[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-CORE-GUIDE#work-contract")]
        pub struct $name(u64);
...
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-CORE-GUIDE#work-readiness")]
