...
specmark::scope!("spec://org.vibevm.zap/zap/flows/zap/ZAP-AGENT-PROTOCOL#AGENT-GOAL-PROJECTION");

#[derive(Clone, Copy, Debug, Eq, Ord, PartialEq, PartialOrd, Serialize, Deserialize)]
#[serde(transparent)]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-CORE-GUIDE#goal-planning")]
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[spec(implements = "spec://org.vibevm.zap/zap/flows/zap/ZAP-AGENT-PROTOCOL#AGENT-GOAL-PROJECTION")]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-CORE-GUIDE#goal-planning")]
    ...
    pub fn validate(&self) -> Result<(), ZapError> {
        ...
        if rebuilt == *self {
            ...
            Err(ZapError::from_static(
                ...
                "spec://org.vibevm.zap/zap/flows/zap/ZAP-AGENT-PROTOCOL#AGENT-GOAL-PROJECTION",
