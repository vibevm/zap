...
#[derive(Clone, Debug)]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-CORE-GUIDE#action-admission")]
...
fn admission_error(message: &'static str) -> ZapError {
    ZapError::from_static(
        ...
        "spec://org.vibevm.zap/zap/flows/zap/ZAP-CHANGE-ECONOMICS#SERVICE-ENFORCEMENT",
        message,
