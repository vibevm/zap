...
specmark::scope!("spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-STORAGE#RUST-STORAGE-SNAPSHOT-TAIL");
...
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-STORE-GUIDE#event-history")]
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-STORE-GUIDE#snapshot-audit")]
