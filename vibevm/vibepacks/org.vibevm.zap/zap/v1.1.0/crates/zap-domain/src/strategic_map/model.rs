...
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP-GUIDE#object-references")]
...
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP-GUIDE#semantic-cards")]
...
#[derive(Clone, Copy, Debug, Eq, Ord, PartialEq, PartialOrd, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP-GUIDE#overview")]
...
#[spec(
    documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP-GUIDE#acceptance-meaning"
)]
...
#[serde(rename_all = "snake_case")]
#[spec(
    documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP-GUIDE#typed-relationships"
)]
...
#[serde(tag = "kind", rename_all = "snake_case")]
#[spec(
    documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP-GUIDE#relationship-coverage"
)]
...
#[serde(tag = "state", rename_all = "snake_case")]
#[spec(
    documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP-GUIDE#descriptive-assessments"
)]
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP-GUIDE#continuations")]
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP-GUIDE#route-projection")]
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP-GUIDE#route-estimates")]
