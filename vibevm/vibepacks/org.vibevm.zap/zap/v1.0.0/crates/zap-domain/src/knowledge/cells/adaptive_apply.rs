...
const REVIEW_REQ: &str = "spec://org.vibevm.zap/zap/flows/zap/ZAP-ADAPTIVE-CYCLE#ATOMIC-REVIEW";
...
fn apply_review_transition(
        ...
        || !job_reconciliation_is_complete(&review, &affected_scope.jobs, &job_impact)
    {
        return Err(ZapError::from_static(
            ...
            "spec://org.vibevm.zap/zap/flows/zap/ZAP-ADAPTIVE-CYCLE#LIVE-WORK-RECONCILIATION",
