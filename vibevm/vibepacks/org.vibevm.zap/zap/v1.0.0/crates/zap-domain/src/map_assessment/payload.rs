...
specmark::scope!("spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP#MAP-WORK-ASSESSMENT");

schema_tag!(
    MapWorkAssessmentProposedSchema,
    "zap-domain/map-work-assessment-proposed/1",
    "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#map-work-assessment"
);
