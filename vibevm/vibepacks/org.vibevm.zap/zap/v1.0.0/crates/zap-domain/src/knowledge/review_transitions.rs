...
pub fn propose_review(payload: &ReviewProposed) -> Result<AdaptiveReviewRecord, ZapError> {
        ...
        || !ownership_unique
    {
        return refuse(
            ...
            "spec://org.vibevm.zap/zap/flows/zap/ZAP-ADAPTIVE-CYCLE#REVIEW-RECORD",
...
pub fn expand_sparse_dispositions(
        ...
        || changed_by_id.keys().any(|id| !active_ids.contains(id))
    {
        return refuse(
            ErrorCode::Conflict,
            "spec://org.vibevm.zap/zap/flows/zap/ZAP-ADAPTIVE-CYCLE#LOSSLESS-REVISION",
...
pub fn apply_review_marker(
        ...
        || !jobs_reconciled
    {
        return refuse(
            ...
            "spec://org.vibevm.zap/zap/flows/zap/ZAP-ADAPTIVE-CYCLE#ATOMIC-REVIEW",
...
pub fn build_proof_reuse(
        ...
        || review.transition.next_outcome_id.as_ref() != Some(to_outcome_id)
    {
        return refuse(
            ErrorCode::Conflict,
            "spec://org.vibevm.zap/zap/flows/zap/ZAP-ADAPTIVE-CYCLE#EVIDENCE-APPLICABILITY",
...
pub fn reconcile_work_change(
    ...
    if current.work_id != change.work_id {
        return refuse(
            ErrorCode::StaleBasis,
            "spec://org.vibevm.zap/zap/flows/zap/ZAP-ADAPTIVE-CYCLE#PLAN-RECONCILIATION",
...
pub fn propose_fact(payload: &FactProposed) -> Result<FactRecord, ZapError> {
        ...
        || !sorted_unique_nonempty(&payload.source_refs)
    {
        return refuse(
            ErrorCode::InvalidValue,
            "spec://org.vibevm.zap/zap/flows/zap/ZAP-DATA-AND-VIEWER#NORMATIVE-AND-MEASURED",
