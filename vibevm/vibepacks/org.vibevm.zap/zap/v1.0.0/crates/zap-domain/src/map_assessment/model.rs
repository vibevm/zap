...
specmark::scope!("spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP#MAP-ASSESSMENT-DIMENSIONS");
...
#[spec(
    implements = "spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP#MAP-ASSESSMENT-DIMENSIONS"
)]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#map-work-assessment")]
...
#[derive(Clone, Copy, Debug, Eq, Ord, PartialEq, PartialOrd, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
#[spec(implements = "spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP#MAP-ASSESSMENT-BASIS")]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#map-work-assessment")]
...
#[spec(implements = "spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP#MAP-EFFORT-SCOPE")]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#map-work-assessment")]
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
#[spec(implements = "spec://org.vibevm.zap/zap/flows/zap/ZAP-STRATEGIC-MAP#MAP-WORK-ASSESSMENT")]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-DOMAIN-GUIDE#map-work-assessment")]
