...
pub(crate) const SELECTION_REQUIREMENT: &str =
    "spec://org.vibevm.zap/zap/flows/zap/ZAP-MILESTONES#INFORMATION-SELECTION";
pub(crate) const REUSE_REQUIREMENT: &str =
    "spec://org.vibevm.zap/zap/flows/zap/ZAP-MILESTONES#INFORMATION-REUSE";
...
#[specmark::spec(
    documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-INFORMATION-GUIDE#opportunity"
)]
...
#[specmark::spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-INFORMATION-GUIDE#commands")]
...
#[specmark::spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-INFORMATION-GUIDE#query")]
