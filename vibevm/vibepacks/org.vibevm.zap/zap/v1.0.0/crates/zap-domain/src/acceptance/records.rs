...
#[spec(
    implements = "spec://org.vibevm.zap/zap/flows/zap/ZAP-METHODOLOGY#FACT-EVIDENCE-DISTINCTION"
)]
#[spec(
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
#[spec(implements = "spec://org.vibevm.zap/zap/flows/zap/ZAP-METHODOLOGY#STAGE-EXITS")]
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
#[spec(implements = "spec://org.vibevm.zap/zap/flows/zap/ZAP-METHODOLOGY#PROMOTE-FACTS")]
