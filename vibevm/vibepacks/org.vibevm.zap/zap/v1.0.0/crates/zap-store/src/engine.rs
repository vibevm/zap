...
#[derive(Clone)]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-STORE-GUIDE#store-lifecycle")]
...
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-STORE-GUIDE#transaction-handles")]
pub struct RedbRead {
