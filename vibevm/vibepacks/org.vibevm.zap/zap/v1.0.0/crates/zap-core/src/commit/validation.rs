...
pub(super) fn missing_completion_provider() -> ZapError {
    ZapError::from_static(
        ...
        "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUNTIME#RUNTIME-COMPLETION-PREDICATE",
...
pub(super) fn missing_artifact_provider() -> ZapError {
    ZapError::from_static(
        ErrorCode::Unavailable,
        "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-STORAGE#RUST-STORAGE-LARGE-ARTIFACT-PROTOCOL",
...
pub(super) fn replay_invariant() -> ZapError {
    ZapError::from_static(
        ...
        "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-STORAGE#RUST-STORAGE-AUDIT",
