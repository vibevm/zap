...
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-CORE-GUIDE#resume-projection")]
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[spec(implements = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUNTIME#RUNTIME-COMPACTION-RESUME")]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-CORE-GUIDE#resume-projection")]
