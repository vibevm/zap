...
specmark::scope!("spec://org.vibevm.zap/zap/flows/zap/ZAP-METHODOLOGY#root");

/// The shared, typed campaign-completion result.
#[derive(Clone, Debug, Eq, PartialEq, Serialize)]
#[spec(documents = "spec://org.vibevm.zap/zap/flows/zap/ZAP-RUST-CORE-GUIDE#completion-evaluation")]
...
fn duplicate_provider() -> ZapError {
    ZapError::from_static(
        ...
        "spec://org.vibevm.zap/zap/flows/zap/ZAP-METHODOLOGY#root",
