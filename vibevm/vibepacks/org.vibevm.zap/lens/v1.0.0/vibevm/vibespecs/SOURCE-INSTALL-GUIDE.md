...
```text
node <settings-dir>/opt/apps/zap/vibevm/vibedeps/org.vibevm.zap.lens/1.0.0/tooling/install-source.mjs status --settings-dir <settings-dir>
node <settings-dir>/opt/apps/zap/vibevm/vibedeps/org.vibevm.zap.lens/1.0.0/tooling/install-source.mjs uninstall --settings-dir <settings-dir>
```
...
The bootstrap creates a marked dedicated Vibe host, pins Lens 1.0.0 and, by
default, the engine 1.0.0, then asks Vibe to materialize those packages. It
